...
VARIABLES db_request_sent, t, request_sent, response_sent, match, response_received, Fluent2, db_response_sent

vars == <<db_request_sent, t, request_sent, response_sent, match, response_received, Fluent2, db_response_sent>>

CandSep ==
\E var0 \in DbRequestId : Fluent2[var0]
...
/\ db_response_sent = {}
/\ t = {}
/\ Fluent2 = [ x0 \in DbRequestId |-> TRUE]
