...
one sig ServerProcessDbResponse extends BaseName {} {
	maxParam = P2
}
one sig ServerProcessDbResponsen2id1resp1 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n2 + P1->id1 + P2->resp1)
}
one sig ServerProcessDbResponsen1id1resp2 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n1 + P1->id1 + P2->resp2)
}
one sig ServerProcessDbResponsen2id2resp2 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n2 + P1->id2 + P2->resp2)
}
one sig ServerProcessDbResponsen2id1resp2 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n2 + P1->id1 + P2->resp2)
}
one sig ServerProcessDbResponsen1id2resp1 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n1 + P1->id2 + P2->resp1)
}
one sig ServerProcessDbResponsen1id2resp2 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n1 + P1->id2 + P2->resp2)
}
one sig ServerProcessDbResponsen1id1resp1 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n1 + P1->id1 + P2->resp1)
}
one sig ServerProcessDbResponsen2id2resp1 extends Act {} {
	baseName = ServerProcessDbResponse
	params = (P0->n2 + P1->id2 + P2->resp1)
}
...
fact {
	...
	no OnceVar.baseName & ReceiveResponse
...
one sig var0toresp2var2toreq2var1toid2 extends Env {} {
	maps = var0->resp2 + var2->req2 + var1->id2
}
one sig var0toresp1var2toreq2var1toid2 extends Env {} {
	maps = var0->resp1 + var2->req2 + var1->id2
}
one sig var1toid1var0toresp2var2toreq2 extends Env {} {
	maps = var1->id1 + var0->resp2 + var2->req2
}
one sig var0toresp2var2toreq1var1toid2 extends Env {} {
	maps = var0->resp2 + var2->req1 + var1->id2
}
...
one sig var0toresp1var1toid1var2toreq2 extends Env {} {
	maps = var0->resp1 + var1->id1 + var2->req2
}
one sig var0toresp1var2toreq1var1toid2 extends Env {} {
	maps = var0->resp1 + var2->req1 + var1->id2
}
one sig var1toid1var0toresp2var2toreq1 extends Env {} {
	maps = var1->id1 + var0->resp2 + var2->req1
}
one sig var0toresp1var1toid1var2toreq1 extends Env {} {
	maps = var0->resp1 + var1->id1 + var2->req1
}


one sig NT extends NegTrace {} {
  lastIdx = T3
  path = (T0->NewRequestn1req1 + T1->ServerProcessRequestn1req1id1 + T2->ServerProcessDbResponsen1id1resp1 + T3->ReceiveResponsen1resp1)
}

one sig PT1 extends PosTrace {} {
  lastIdx = T3
  path = (T0->NewRequestn1req1 + T1->ServerProcessRequestn1req1id1 + T2->ServerProcessRequestn1req1id2 + T3->DbProcessRequestid2req1resp1)
}
